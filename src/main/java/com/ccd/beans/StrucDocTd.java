...
public class StrucDocTd extends ANY{
    ...
    @XmlElement(name="content", namespace="urn:hl7-org:v3")
    protected StrucDocContent content2;  //added by manish on JUNE 3,2014
    
    @XmlElement(name="list", namespace="urn:hl7-org:v3")
    protected StrucDocList list; //added by manish on JULY 01,2014
    /**
	 * @return the content2
	 */
