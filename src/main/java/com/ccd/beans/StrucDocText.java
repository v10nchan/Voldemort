...
public class StrucDocText extends ANY {
	 ...
	 * @return the content2
	 */
	public StrucDocContent getContent2() {
		return content2;
	}
	 ...
	 */
	public void setContent2(StrucDocContent content2) {
    ...
    protected StrucDocTable table;  //added by manish on JUNE 3,2014
    @XmlElement(namespace="urn:hl7-org:v3", name="content")
    protected StrucDocContent content2; //added by manish on JUNE 9,2014
    @XmlElement(namespace="urn:hl7-org:v3", name="list")
    protected StrucDocList list;//added by manish on JUNE 9,2014
	 ...
	 */
	public StrucDocParagraph getParagraph() {
		return paragraph;
	}
	 ...
	 */
	public void setParagraph(StrucDocParagraph paragraph) {
	 ...
	 */
	public void setTable(StrucDocTable table) {
		this.table = table;
	}
	 ...
	 */
	public void setList(StrucDocList list) {
		this.list = list;
	}
