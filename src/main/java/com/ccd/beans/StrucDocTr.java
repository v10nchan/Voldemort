...
public class StrucDocTr extends ANY{

    @XmlElements({
        @XmlElement(name = "th", namespace = "urn:hl7-org:v3", required = true, type = StrucDocTh.class),
        @XmlElement(name = "td", namespace = "urn:hl7-org:v3", required = true, type = StrucDocTd.class)
    })
