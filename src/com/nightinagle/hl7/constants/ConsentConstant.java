...
public class ConsentConstant {
	...
	// Consent Value
	    public static final String NO_CONSENT_REQUIRED_VALUE = "N";
		public static final String ONE_TIME_CONSENT_CODE_VALUE = "O";
		public static final String ONE_TIME_CONSENT_PENDING_CODE_VALUE = "OP";
