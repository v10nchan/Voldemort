 ...
 * @author ajayr
 */
public class OBXBeanPopulater {
	private final static Logger LOGGER = LoggerFactory.getLogger(OBXBeanPopulater.class);
	private SimpleDateFormat sdf = new SimpleDateFormat("YYYYMMdd");

	public List<OBXBean> populateOBXBean(DBDataBean dataBean, int count) {
	               ...
	               // else {
	                ...
	                //}
	                    if(count==2) {
                            ...
                            OBXBean obxBean8 = new OBXBean();
                            obxBean8.setOccurrenceId("8");
                            obxBean8.setValueType("CE");
                            obxBean8.setObservationId("30956-7");
                            obxBean8.setObservationText("vaccine type");
                            obxBean8.setObservationNCS("LN");
                            obxBean8.setObservationSubId("4");
                            obxBean8.setObservationValueIdentifier("17");
                            obxBean8.setObservationValueText("Hib");
                            obxBean8.setObservationValueNCS("CVX");
                            obxBean8.setObservationResultStatus("F");
                            
                            obxBeanList.add(obxBean8);
                            
                            OBXBean obxBean9 = new OBXBean();
                            obxBean9.setOccurrenceId("9");
                            obxBean9.setValueType("TS");
                            obxBean9.setObservationId("29768-9");
                            ...
                            OBXBean obxBean10 = new OBXBean();
                            obxBean10.setOccurrenceId("10");
                            obxBean10.setValueType("TS");
                            obxBean10.setObservationId("29769-7");
