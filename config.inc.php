...
$config['db_dsnw'] = 'mysql://roundcube:Chetu%40123@localhost/roundcubemail';
...
$config['default_host'] = array('ssl://imap.gmail.com', 'ssl://mail.nexiaemr.com', 'ssl://mail.nexiaemail.com');
...
// For example %n = mail.domain.tld, %t = domain.tld
$config['smtp_server'] = 'mail.nexiaemail.com';
